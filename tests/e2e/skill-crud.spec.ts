...
test.describe('Playwright Test Skill CRUD', () => {
  ...
  test('should create skill entity through web UI', async ({ page }) => {
    ...
    await page.fill('input[name="name"], input[data-testid="name"]', 'Test Skill Entity')
    await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'A test skill for Playwright testing')
    ...
    await page.waitForURL('**/manage/skills')
    await page.waitForLoadState('networkidle')
  ...
  test('should edit skill entity and add translations', async ({ page }) => {
    ...
    // Edit basic fields
    await page.fill('input[name="name"], input[data-testid="name"]', 'Updated Test Skill Name')
    await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'Updated description for test skill')
    ...
    const updatedRow = page.locator(`text=Updated Test Skill Name`)
    ...
    if (await languageSelector.count() > 0) {
      ...
      await page.fill('input[name="name"], input[data-testid="name"]', 'Habilidad de Prueba Actualizada')
      await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'Descripción actualizada para habilidad de prueba')
  ...
  test('should delete skill entity through web UI', async ({ page }) => {
