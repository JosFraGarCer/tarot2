...
test.describe('Playwright Test World CRUD', () => {
  ...
  test('should create world entity through web UI', async ({ page }) => {
    // Navigate to manage worlds
    await page.goto('/manage/worlds')
    await page.waitForLoadState('networkidle')
    ...
    await page.fill('input[name="name"], input[data-testid="name"]', 'Test World Entity')
    await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'A test world for Playwright testing')
    ...
    await page.waitForURL('**/manage/worlds')
    await page.waitForLoadState('networkidle')
  ...
  test('should edit world entity and add translations', async ({ page }) => {
    ...
    // Edit basic fields
    await page.fill('input[name="name"], input[data-testid="name"]', 'Updated Test World Name')
    await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'Updated description for test world')
    ...
    const updatedRow = page.locator(`text=Updated Test World Name`)
    ...
    if (await languageSelector.count() > 0) {
      ...
      await page.fill('input[name="name"], input[data-testid="name"]', 'Mundo de Prueba Actualizado')
      await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'Descripción actualizada para mundo de prueba')
  ...
  test('should delete world entity through web UI', async ({ page }) => {
