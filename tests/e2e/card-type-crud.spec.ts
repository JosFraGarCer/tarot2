...
test.describe('Playwright Test Card Type CRUD', () => {
  ...
  test('should create card type entity through web UI', async ({ page }) => {
    // Navigate to manage card types
    await page.goto('/manage/card-types')
    await page.waitForLoadState('networkidle')
    ...
    await page.fill('input[name="name"], input[data-testid="name"]', 'Test Card Type Entity')
    await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'A test card type for Playwright testing')
    ...
    await page.waitForURL('**/manage/card-types')
    await page.waitForLoadState('networkidle')
  ...
  test('should edit card type entity and add translations', async ({ page }) => {
    ...
    // Edit basic fields
    await page.fill('input[name="name"], input[data-testid="name"]', 'Updated Test Card Type Name')
    await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'Updated description for test card type')
    ...
    const updatedRow = page.locator(`text=Updated Test Card Type Name`)
    ...
    if (await languageSelector.count() > 0) {
      ...
      await page.fill('input[name="name"], input[data-testid="name"]', 'Tipo de Carta de Prueba Actualizado')
      await page.fill('textarea[name="description"], textarea[data-testid="description"]', 'Descripción actualizada para tipo de carta de prueba')
  ...
  test('should delete card type entity through web UI', async ({ page }) => {
